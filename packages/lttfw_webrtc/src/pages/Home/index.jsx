    ...
    <>
      ...
      <Box sx={rootSX}>
        ...
        >
          ...
          <BottomNavigationAction label="Video Chat" icon={<i className="fa-solid fa-video" />} />
          <BottomNavigationAction label="Messages" icon={<i className="fa-solid fa-comments" />} />
          <BottomNavigationAction label="Screen sharing" icon={<i className="fa-solid fa-display" />} />
        </BottomNavigation>
      </Box>
    </> :
    <>
